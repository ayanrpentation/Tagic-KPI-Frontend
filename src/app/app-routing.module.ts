...
const routes: Routes = [{
  ...
  { 
    path: 'upload/:channelId/:id/:month/:year',
    // path: 'upload/:id',
  ...
  { path: 'channelwiseMail',
  component: ChannelwiseViewMailComponent},
  
  { path: 'add_new_param',
  component: NewParamAddComponent},
  { path: 'param_sequence',
    component: ParameterSequenceComponent},
  ]
}];
