...
export class HeaderComponent implements AfterViewInit, OnInit {
    ...
    length_defaultChannel = 0 as any;
    ...
    ngOnInit(): void {
        ...
        if(sessionStorage.getItem('defaultChannelForAll') == '0'){
            this.selectedDefaultChannel = 'all'
        }
        else if(this.length_defaultChannel>1){
            this.selectedDefaultChannel = 'all'
        }
        else if(this.length_defaultChannel == 1){
            this.selectedDefaultChannel = sessionStorage.getItem('defaultChannelForAll')
        }
        // console.log(typeof this.selectedDefaultChannel, this.selectedDefaultChannel )
        ...
        if(this.firstLoadafterLogin == 'true'){
            ...
            // console.log("selectedDefaultChannel", this.selectedDefaultChannel, typeof(this.selectedDefaultChannel))
    ...
    lengthCheck(){
        let default_channel = sessionStorage.getItem('defaultChannelForAll') as any
        let stringArray = default_channel.split(',');
        // let numberArray = stringArray.map(Number);
        this.length_defaultChannel = stringArray.length
        // console.log("this.length_defaultChannel ",this.length_defaultChannel)
    }
