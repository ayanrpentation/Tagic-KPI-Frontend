...
@Component({
  selector: 'app-sdm-unmapped-details',
  templateUrl: './sdm-unmapped-details.component.html',
  styleUrls: ['./sdm-unmapped-details.component.css']
})
export class SdmUnmappedDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.moduleId = this.common.getSdmUnmappedId();
    this.getColumnName();
  ...
  uploadFileGeneric(event: any): any {
