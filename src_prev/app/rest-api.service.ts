...
export class RestApiService {
  ...
  // API_ROOT = 'http://127.0.0.1:5013';
  // file_path = 'http://127.0.0.1:5013/static';

  // API_ROOT = 'http://127.0.0.1:5020';
  // file_path = 'http://127.0.0.1:5020/static';

  API_ROOT = 'http://192.168.1.10:5020';
  file_path = 'http://192.168.1.10:5020/static';
  ...
  getAllChannel() {
    return this.http.get(this.API_ROOT + '/kpimap/getAllChannel')


  }
  getAllChannelNew(){
    return this.http.get(this.API_ROOT + '/kpimap/getAllChannelNew')
  ...
  getAllRuleData(){
    return this.http.get(this.API_ROOT + '/master/getAllRuleData')
...
getChannelWiseKpiParamList(data:any){
  return this.http.post(this.API_ROOT + '/master/getChannelWiseKpiParamList', data);}
...
allKpiRuleCopy(data: any) { return this.http.post(this.API_ROOT + '/master/allKpiRuleCopy', data);}
selectiveKpiRuleCopy(data: any) { return this.http.post(this.API_ROOT + '/master/selectiveKpiRuleCopy', data);}
getDistParameterList(data: any) { return this.http.post(this.API_ROOT + '/master/getDistParameterList', data);}
